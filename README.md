...
This project is maintained by Dharmi Tejani, a Supply Chain Analyst with over 3 years of experience in optimizing end-to-end operations. With a technical background in Python, SQL, and Scikit-learn, Dharmi focuses on bridging the gap between complex data science workflows and production-ready business solutions.
